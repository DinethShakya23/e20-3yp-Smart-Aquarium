                      ...
                      children: [
                        ...
                        CustomButton(
                          ...
                          onPressed: () async {
                            ...
                            String confirmPassword = passwordControllerconform.text.trim();
                            ...
                            try {
                              final response = await http.post(
                                Uri.parse('http://18.140.68.45:3001/api/register'),
                        ...
                        const Divider(color: Color(0xFFD0F0FF), thickness: 3.0),
                        const Text(
                          "Or Login with",
                          style: TextStyle(
                        ...
                        Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            const Icon(Icons.facebook, color: Color(0xFF1e52e6), size: 55.0),
                            const SizedBox(width: 25),
                            const Icon(Icons.apple, size: 55.0),
                            const SizedBox(width: 25),
                            Image.asset('assert/images/Google_logo.png', width: 55, height: 55),
                          ],
                        ),
                        const SizedBox(height: 20),
                        RichText(
